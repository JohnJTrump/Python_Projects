...
def describe_game(name):
    ...
    if name != "": # "!=" operator means 'not equal'
...
def win(nice,mean,name):
    # Substitute the {} wildcards with your variable values
    print("\nNice job {}, you win!  \nBeing nice can be easy and you can \nmake lots of friends along the way!".format(name))
...
def lose(nice,mean,name):
    ...
    print("\nAhhh to bad, game over! \n{}, your inability to co-mingle \nin society will not serve you well".format(name))
    # call again function and pass in our variables
    again(nice,mean,name)
